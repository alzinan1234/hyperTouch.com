          ...
          <div className="group bg-white relative border-2 border-gray-400 cursor-pointer ">
            <div className="w-[100%] h-[100%] menu-text-link absolute flex  justify-center items-center z-50 duration-300 group-hover:bg-[#00000097] bg-[#00000073]">
              <div className="d">
                ...
                <h1
                 ...
                 text-center text-[12px] items-center text-gray-800 font-bold uppercase bg-white px-3 py-2 rounded-md"
                >
                  Shop Now
                </h1>
              </div>
            ...
            <div className="relative h-[120px] md:h-[300px]">
              <Image
                src={item.image}
                alt={item.name}
                className="rounded-lg  w-[100%] h-[100%] object-contain md:object-cover touch-pinch-zoom"
              />
            </div>
          </div>
        </SwiperSlide>
